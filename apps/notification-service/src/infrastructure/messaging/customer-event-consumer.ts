...
/** Consume banking.customer.events: notifica en CustomerSuspended, ignora el resto
 * (CustomerRegistered, CustomerVerified, CustomerContactUpdated). */
@Injectable()
export class CustomerEventConsumer implements OnModuleInit, OnModuleDestroy {
  ...
  private static readonly CONSUMER_NAME = 'notification-service-customer';
